/**
 * @file DrizzleInventoryRepository.ts
 * @description 庫存 Repository Drizzle ORM 實現
 *
 * 使用 Drizzle ORM 作為 ORM，支援樂觀鎖機制。
 */
